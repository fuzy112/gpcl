/// @defgroup customisation_point customisation Points
///
/// A customisation point object is a function object
...
/// interaction.
///
/// The type of a customisation point object, ignoring cv-qualifiers, shall
/// model semiregular ([concepts.object]).
///
/// All instances of a specific customisation point object type shall be equal
/// ([concepts.equality]). The effects of invoking different instances of a
/// specific customisation point object type on the same arguments are
/// equivalent.
///
/// The type T of a customisation point object, ignoring cv-qualifiers, shall
/// model invocable<T&, Args...>, invocable<const T&, Args...>, invocable<T,
/// Args...>, and invocable<const T, Args...> ([concept.invocable]) when the
/// types in Args... meet the requirements specified in that customisation point
/// object's definition. When the types of Args... do not meet the customisation
/// point object's requirements, T shall not have a function call operator that
/// participates in overload resolution.
///
/// For a given customisation point object o, let p be a variable initialized as
...
///
/// Each customisation point object type constrains its return type to model a
/// particular concept.
///
/// [Note 1: Many of the customisation point objects in the library evaluate
...
/// customisation point objects specify that lookup for these expressions is
...
/// a customisation point object. — end note]
///